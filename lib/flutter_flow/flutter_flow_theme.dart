...
class LightModeTheme extends FlutterFlowTheme {
  late Color primaryColor = const Color(0xFF7B4F94);
  late Color secondaryColor = const Color(0xFFF884E1);
  late Color tertiaryColor = const Color(0xFFB9B9B9);
  late Color alternate = const Color(0xFF3F3F3F);
